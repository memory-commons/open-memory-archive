...
| `relationship` | [`schema:Relationship`](https://schema.org/Relationship) | [`E13 Attribute Assignment`](https://cidoc-crm.org/Entity/e13-attribute-assignment/version-7.1.1) | [`Relationship`](https://gedcomx.org/v1/Relationship) |
